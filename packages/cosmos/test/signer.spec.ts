  ...
  describe('getPayload', () => {
    ...
    it('gets payload for document request', () => {
      ...
      const expected = new Uint8Array([
        ...
        100, 97, 116, 97, 98, 97, 115, 101, 47, 99, 111, 108, 108, 115, 47, 109,
        121, 99, 111, 108, 108, 101, 99, 116, 105, 111, 110, 47, 100, 111, 99,
        115, 47, 120, 121, 122, 10, 102, 114, 105, 44, 32, 48, 54, 32, 100, 101,
        99, 32, 50, 48, 49, 57, 32, 48, 55, 58, 50, 57, 58, 52, 54, 32, 103,
        109, 116, 10, 10
      ]);
      expect(signer.getPayload(request, date)).to.eql(expected);
    });
